...
function DashboardPage() {
    ...
    const loadData = async ()=>{
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').order('created_at', {
                ascending: false
            });
            setProjects(data || []);
        } catch (error) {
...
_s(DashboardPage, "PJa9YzKfPde/U5L1XScSCb1kq0k=", false, function() {
    return [
    ...
    const loadStats = async ()=>{
        try {
            const [k, c, ch] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('keywords').select('id', {
                    count: 'exact'
                }).eq('project_id', project.id),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('competitors').select('id', {
                    count: 'exact'
                }).eq('project_id', project.id),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('serp_changes').select('id', {
                    count: 'exact'
                }).eq('project_id', project.id)
            ]);
            setStats({
...
_s1(ProjectCard, "pmldaBMNNDu7EWuTha8xv+m9lAI=");
_c1 = ProjectCard;
